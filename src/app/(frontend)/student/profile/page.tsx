...
function Field({ label, value }: { label: string; value?: null | string }) { return <div><dt className="text-sm text-muted-foreground">{label}</dt><dd className="mt-1 font-semibold text-navy">{value || 'Not provided'}</dd></div> }

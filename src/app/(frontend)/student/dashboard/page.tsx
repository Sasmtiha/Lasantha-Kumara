  ...
  return (
    <div className="container py-12">
      ...
      <div className="mt-10 rounded-3xl border bg-white p-7">
        <h2 className="text-2xl font-bold text-navy">Quick links</h2>
...
function DashboardCard({ label, value }: { label: string; value: string }) {
  return <article className="rounded-2xl border bg-white p-6 shadow-sm"><p className="text-sm text-muted-foreground">{label}</p><p className="mt-2 text-2xl font-bold capitalize text-navy">{value}</p></article>
}
